  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-4 py-12">
      ...
      >
        ...
        <p className="mx-auto mb-8 max-w-sm text-balance text-base font-semibold text-muted-foreground sm:text-lg">
          Matematika sizning super kuchingizga aylanadigan sarguzasht! 🚀
        </p>

        <div className="flex flex-col gap-3 sm:grid sm:grid-cols-2 sm:items-stretch sm:gap-3">
          <motion.button
            type="button"
          ...
          <motion.button
            ...
            className="inline-flex w-full min-w-0 items-center justify-center rounded-2xl border-2 border-border bg-card/80 px-5 py-4 text-base font-bold text-foreground shadow-sm backdrop-blur-sm transition-colors hover:bg-muted/50 sm:text-lg"
          >
            Kirish
          </motion.button>
        </div>
